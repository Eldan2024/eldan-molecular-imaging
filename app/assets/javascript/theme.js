!(function () {
    ...
    (t = function () {
      ...
      class ss extends R {
        ...
        _toggleDropDown(e, t) {
          ...
          n(nJ, n7), n('.dropdown-menu', nG), i.setAttribute('aria-expanded', t)
        }
  ...
  ;((e, t, i) => {
    ...
    let i, n
    void 0 != t.dataset.swiperOptions &&
      (i = JSON.parse(t.dataset.swiperOptions)),
      i.pager &&
        (n = {
          pagination: {
    ...
    (() => {
      ...
      for (let t = 0; t < e.length; t++) {
        ...
        noUiSlider.create(i, {
          ...
          format: {
            to: function (e) {
              return r.dataTooltipPrefix + parseInt(e, 10) + r.dataTooltipSuffix
            },
            from: function (e) {
              return Number(e)
            }
          ...
          let d = (e) => {
            ...
            g = () => {
              if (n.buffered.length > 0) {
                ...
                i.style.setProperty('--buffered-width', `${(e / r.max) * 100}%`)
              }
            },
            m = () => {
